          ...
          {categories &&
            categories.map(sole_category => (
              <div
                ...
                className="flex flex-col w-24 min-w-[94px] h-28 bg-card hover:bg-cartNumBg group cursor-pointer rounded-lg drop-shadow-xl gap-3 transition-all ease-in-out duration-150 items-center justify-center"
              >
